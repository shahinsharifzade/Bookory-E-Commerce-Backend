...
public class AuthorPutImageResolver : IValueResolver<AuthorPutDto, Author, ICollection<AuthorImage>>
{
    private readonly IWebHostEnvironment _webHostEnvironment;

    public AuthorPutImageResolver(IWebHostEnvironment webHostEnvironment)
    {
        _webHostEnvironment = webHostEnvironment;
    }

    public ICollection<AuthorImage> Resolve(AuthorPutDto source, Author destination, ICollection<AuthorImage> destMember, ResolutionContext context)
    {
